          ...
          >
            <div className=' lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col gap-10 lg:h-auto '>
              <Link href='/'>
                <a
                  onClick={closeOnclick}
                  className='lg:inline-flex lg:w-auto w-full  py-0  items-center justify-center  font-light transition duration-500 ease-in-out hover:text-base transform sm:hover:-translate-y-1  hover:translate-x-8 hover:scale-110 ...'
                >
                  Home
                </a>
              </Link>
