...
const singleEducation = ({ title, subTitle, year, description }) => {
  return (
    <Fade cascade duration={200} direction="right">
      <div className=" border border-marron border-dashed mr-2 z-20 shadow project leading-loose mt-4 bg-white text-marron rounded p-2 transition transform  hover:shadow-xl hover:cursor-crosshair ease-in-out duration-300">
